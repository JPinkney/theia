...
@injectable()
export class DebugThreadSelectionService implements SelectionProvider<ThreadSelection> {

    private currentSelection: ThreadSelection;
    private selectionListeners: Emitter<any> = new Emitter();

    get selection(): ThreadSelection {
        return this.currentSelection;
    }

    set selection(selection: ThreadSelection) {
